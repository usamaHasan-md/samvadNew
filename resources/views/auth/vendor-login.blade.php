...
<title>Samvad | Vendor | Login</title>
 <style>
    .js-error {
      font-weight: 500;
      color: red;
        ...
        <main class="authentication-content">
            <div class="container-fluid">
                <div class="authentication-card">
                    ...
                    <!-- @endif-->
                    <form class="form-body vldt-form" action="{{route('logedin.vendor')}}" method="post">
                        @csrf
                        ...
                        <div class="row g-3">
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="text" name="contact" class="form-control radius-30 ps-5 vldt requd" id="inputContactNumber" placeholder="Contact Number">
                            </div>
                          </div>
                          <div class="col-12">
