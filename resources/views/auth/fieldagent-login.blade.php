...
<title>Samvad | Field Agent | Login</title>
</head>
<body>
    <!--start wrapper-->
    <div class="wrapper">
        ...
        <main class="authentication-content">
            <div class="container-fluid">
                <div class="authentication-card">
                    ...
                    <!-- @endif-->
                    <form class="form-body" action="{{route('logedin.fieldagent')}}" method="post">
                        @csrf
                        ...
                        <div class="row g-3">
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="text" name="number" class="form-control radius-30 ps-5" id="inputContactNumber" placeholder="Contact Number">
                            </div>
                          </div>
                          <div class="col-12">
