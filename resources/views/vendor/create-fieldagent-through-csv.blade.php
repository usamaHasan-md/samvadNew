...
<div class="row">
    <div class="col-xl-9 mx-auto">
        ...
        <div class="col-auto mb-3 ms-auto text-end" >
                <a href="{{route('vendor.dashboard')}}" class="btn btn-primary btn-sm">Back<i class="fa fa-arrow-left ms-1"></i></a>
        </div>
        <div class="card thm-card">
             <div class="card-header thm-card-head bg-gradient-danger d-flex flex-wrap align-items-center justify-content-between">
                 <h5 class="card-title thm-card-title  mb-sm-0 mb-3 m-0">
                     Create Field Agent Through CSV<i class="fa fa-user-plus ms-2"></i>
                 </h5>
                 <a href="{{ route('downloadFieldAgentCsv.Sample') }}" class="btn btn-outline-light">
            ...
            <div class="card-body thm-card-body">
                <div class="rounded">
                    ...
                    <div>
                        <form action="{{ route('importFieldAgentCsv.file') }}" method="POST" enctype="multipart/form-data">
                            @csrf
