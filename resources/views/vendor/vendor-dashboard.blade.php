...
<div class="container">
            ...
            <div class="card radius-10 mb-3 dashboard-title-card">
                <div class="card-body text-center px-lg-5 px-3">
                    <div class="dashboard-title">
                        ...
                        <span class="dashboard-subtitle">Vendor Management Dashboard</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2 row-cols-xxl-4">
                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Total Assigned Campaigns</p>
                                <h4 class="my-1 text-dark">{{$totalCampaigns}}</h4>
        ...
        <div class="col">
            <a href="{{route('vendor.ongoingCampaigns')}}">
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Total Ongoing Campaigns</p>
        ...
        <div class="col">
            <a href="{{route('fieldagent.list')}}">
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Total Field Agents</p>
                                <h4 class="my-1 text-dark">{{$totalFieldAgents}}</h4>
            ...
            <a href="{{route('vendor.ongoingCampaigns')}}">
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Verified Image</p>
                                <h4 class="my-1 text-dark">{{$totalverifiedimg}}</h4>
                            ...
                            @foreach ($categoryWise as $category => $subcategories)
                                @foreach ($subcategories as $key => $subcategory)
                                    @php
                                        ...
                                        $url = route('fieldagent.report').'?'.$query;
                                    @endphp
